        ...
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="" method=""><!--HTTP VERB-->
                    ...
                    <div>
                        <input id="cb1" type="checkbox" name="cb1" value="1" <?php echo $checkbox?>>
                        <label for="cb1" class="label-inline">Check This box</label>
                    </div>
                    <div>
                        <label>Some Other Fruits</label>
                        ...
                        <input type="checkbox" name="fruits[]" value="pine" <?php isFruitChecked("pine")?>>
                        <label class="label-inline">Pineapple</label><br/>
                        <input type="checkbox" name="fruits[]" value="grape" <?php isFruitChecked("grape")?>>
                        <label class="label-inline">Grape</label>
                    </div>
